        ...
        return (
            <section id="artistInfo" className="page-content__container">
                ...
                <div className="albums-page__items_wrapper">
                    { this.state.artistAlbums.map((artistAlbums:any, i:any) => <a target="_blank" href={ artistAlbums.url } className="albums-page__single-item" key={ i } style={ { backgroundImage: "url(" + (artistAlbums.image[3]['#text']) + ")" } } >
